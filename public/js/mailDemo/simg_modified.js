...
(function (root) {
    ...
    Simg.prototype = {
        ...
        /**
         * returns an object with width, height, and data
         * @returns {unresolved}
         */
...
//            var str = this.toString(this.svg);
//             
//            var dataItem = {width: 400,height: 400, imageData: btoa(unescape(encodeURIComponent(str))) }
//            return dataItem;
//        },
        ...
        toUsableImg: function (imageRef)
        {
            this.toCanvas(function (canvas) {
                ...
                imageRef.onload = function () {
                      console.log("hit onload for ref")
                };

                //ref data
                 imageRef.setAttribute('src', canvasData);
            });
